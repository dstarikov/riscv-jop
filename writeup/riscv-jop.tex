...
@misc{gu20ropriscv,
    ...
    archivePrefix={arXiv},
    primaryClass={cs.CR},
    note={\url{https://arxiv.org/abs/2007.14995}}
}
@inproceedings{bletsch11jopx86,
    ...
    note = {\url{https://doi.org/10.1145/1966913.1966919}},
...
@inproceedings{shacham07ropx86,
    ...
    publisher = {Association for Computing Machinery},
    address = {New York, NY, USA},
    note = {\url{https://doi.org/10.1145/1315245.1315313}},
...
@inproceedings{patterson98risc,
    ...
    pages={216--230},
    year={1998},
    note={\url{https://doi.org/10.1145/285930.285981}}
}
@inproceedings{checkoway10ropnoret,
    ...
    publisher = {Association for Computing Machinery},
    address = {New York, NY, USA},
    note = {\url{https://doi.org/10.1145/1866307.1866370}},
...
@inproceedings{sadeghi15tinyjop,
    ...
    note = {\url{https://doi.org/10.1109/ISCISC.2015.7387898}}
}
@inbook{jaloyan20ropriscv,
    ...
    publisher = {Association for Computing Machinery},
    address = {New York, NY, USA},
    note = {\url{https://doi.org/10.1145/3320269.3384738}},
...
@misc{zipper,
    ...
    archivePrefix={arXiv},
    primaryClass={cs.CR},
    note={\url{https://arxiv.org/abs/1902.00888}}
}
@inproceedings{bosman14sigrop,
    ...
    note={\url{https://doi.org/10.1109/SP.2014.23}}
}
@inproceedings{payer13sop,
    ...
    publisher = {Association for Computing Machinery},
    address = {New York, NY, USA},
    note = {\url{https://doi.org/10.1145/2430553.2430555}},
...
@InProceedings{shacham15lejit,
  ...
  note = {\url{https://doi.org/10.14722/ndss.2015.23288}}
}
@misc{brainfuck,
    author = {Urban Müller},
    title = {brainfuck, {An} {Eight-Instruction} {Turing-Complete} {Programming} {Language}},
    year = 1993,
    note = {\url{https://www.muppetlabs.com/~breadbox/bf/}}
}
@misc{w^x,
    author = {Theo de Raadt},
    title = {{OpenBSD} 3.3 announcement (public release of {W$\oplus$X)}},
    year = 2003,
    note = {\url{https://www.openbsd.org/33.html}}
}
@misc{riscvgrowth,
    author = {Jeffrey Osier-Mixon},
    title = {{Semico} {Forecasts} {Strong} {Growth} for {RISC-V}},
    year = 2019,
    note = {\url{https://riscv.org/announcements/2019/11/9679/}}
    
}
@inproceedings{buchanan08roprisc,
    ...
    publisher = {Association for Computing Machinery},
    address = {New York, NY, USA},
    note = {\url{https://doi.org/10.1145/1455770.1455776}},
    doi = {10.1145/1455770.1455776},
    pages = {27–38},
    numpages = {12},
    keywords = {SPARC, return-oriented programming, RISC, return-into-libc},
    location = {Alexandria, Virginia, USA},
    series = {CCS '08}
}
@phdthesis{kornau10roparm,
    title={{Return} oriented programming for the {ARM} architecture},
    author={Kornau, Tim and others},
    year={2010},
    school={Master’s thesis, Ruhr-Universit{\"a}t Bochum},
    note={\url{http://www.handgrep.se/repository/ebooks/Security/Reversing/kornau-tim--diplomarbeit--rop.pdf}}
}
@article{pax03aslr,
    title={{Address} {Space} {Layout} {Randomization} ({ASLR}), 2003},
    author={Team, PaX},
...
a new open-source ISA that is gaining popularity in many different settings. We add to
...
innocuous input in a program, and later hijacking control flow to execute this code.
While code injection attacks can be prevented by measures such as ASLR~\cite{pax03aslr} and W$\oplus$X~\cite{w^x}, code \textit{reuse} attacks can bypass these defenses and be just as effective.
Return-oriented-programming is an example of a code reuse attack.
...
itself is usually quite limited. However, when they used together in a sequence, it has
been shown that an attacker can execute arbitrary operations. The attacker
supplies addresses to these gadgets, and other values that they may acquire from
memory. These gadgets are then executed in order as though they are instructions
...
seek to bypass defenses that focus on certain aspects of one or more of their
...
arbitrary calls to \verb|libc|. Furthermore, we present a new recipe of gadgets that
...
brainfuck~\cite{gu20ropriscv,brainfuck} programs through ROP on our VMs. Next we sought to port a variant of
...
achieve this \verb|ret|-like behavior~\cite{checkoway10ropnoret}. We were able to successfully implement
a simplified version of this attack using a real \verb|ret| gadget which incremented
the stack pointer and performed a \verb|ret|, allowing us to reuse the JOP versions of ROP gadgets that
...
\footnote{\texttt{gp}, \texttt{tp}, \texttt{t0}, \texttt{t2}, \texttt{t3}, \texttt{t4}, \texttt{t5}, and \texttt{t6} are the only registers that are not set by this
initializer gadget.}
...
various open source toolsets for this task, but none with current support for RISC-V.
Initially, we manually searched for gadgets using regular expressions on the disassembled
object files. This was both a cumbersome and time consuming task. We also reimplemented the
Galileo search algorithm from~\cite{shacham07ropx86}, but later found an existing tool
that we could contribute to. Ropper~\cite{ropper} is an open source project implementing a gadget scanner built on top of a
...
This program analyzed the same \verb|libc.so.6| file that we used in our earlier
