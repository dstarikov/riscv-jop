...
Finally, we implemented a version of the JOP dispatch-table attack described in
...
% TODO: limitations of not having virtual addresses - need different gadgets to setup t0 and increment it
...
by using a 'super-loader' gadget which relies on a rarely-used register \verb|t0|
...
jumping back to this 'super-loader' in order to setup the next JOP chain.
...
jumping back to this 'super-loader' gadget. The benefit of this 'super-loader'
...
'super-loader' gadget. This incurs a limitation of needing to know the exact
